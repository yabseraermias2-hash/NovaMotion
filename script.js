...
class NovaBuilder {
  ...
  async _aiGenerate(brief, seed, onProgress) {
    const sys = [
      ...
      '- Self-contained: inline <style>, inline <script>. External allowed only for: cdn.tailwindcss.com, fonts.googleapis.com, fonts.gstatic.com, image.pollinations.ai (for AI-generated images — see IMAGES section).',
      '',
